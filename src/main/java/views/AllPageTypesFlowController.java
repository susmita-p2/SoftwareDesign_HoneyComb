...
public class AllPageTypesFlowController {
    ...
    void onPersonPageClick(ActionEvent event) {
    	...
    	ObservableList<PageModel> allPeopleModel = FXCollections.observableArrayList();
	...
	public void setModel(PageModel model, BorderPane mainview, AllPagesModel allPagesModel)
	{
		this.model = model;
